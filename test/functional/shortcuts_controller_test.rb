...
class ShortcutsControllerTest < ActionController::TestCase
  ...
  test "should create shortcut" do
    assert_difference('Shortcut.count') do
      post :create, shortcut: { cheatsheet_id: @shortcut.cheatsheet_id, desc: @shortcut.desc, group_id: @shortcut.group_id, key: @shortcut.key }
    end
  ...
  test "should update shortcut" do
    put :update, id: @shortcut, shortcut: { cheatsheet_id: @shortcut.cheatsheet_id, desc: @shortcut.desc, group_id: @shortcut.group_id, key: @shortcut.key }
    assert_redirected_to shortcut_path(assigns(:shortcut))
  end
